    ...
    <div class="card">
      <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs">
              <li class="nav-item">
                  {!! link_to_route('costomers.operatingList', '未入金', [], ['class' => 'nav-link active']) !!}
              </li>
              <li class="nav-item">
                  {!! link_to_route('costomers.paidList', '入金済み', [], ['class' => 'nav-link']) !!}
              </li>
          </ul>
      </div>
          ...
          <table class="table table-bordered table-hover" id="defo">
            ...
            <tbody class="text-center">
                ...
                <tr>
                  ...
                  <td>
                    {!! Form::open(['route' => ['costomers.paid', $operating->id], 'method' => 'put']) !!}
                      {!! Form::submit('入金済みにする', ['class' => 'btn btn-success']) !!}
                    {!! Form::close() !!}
                  </td>
                </tr>
                @endforeach
